# This is derived from https://github.com/chanzuckerberg/single-cell-explorer/blob/main/server/ecs/app.py
...
class WSGIServer(Server):
    ...
    def _before_adding_routes(app, app_config):
        """
        Required for interaction with gunicorn
        """
    ...
    def compute_inline_csp_hashes(app, app_config):
        dataset_configs = [app_config.dataset_config] + list(app_config.dataroot_config.values())
        hashes = []
...
try:
    ...
    if config_file:
        ...
        # config file: second, look "config.yaml" in the current working directory
        config_location = DataLocator("config.yaml")
    else:
